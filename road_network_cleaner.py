...
import road_network_cleaner_tool
...
class RoadNetworkCleaner:
    ...
    def __init__(self, iface):
        ...
        self.network_cleaner_tool = road_network_cleaner_tool.NetworkCleanerTool(self.iface)
    ...
    def unload(self):
        ...
        #self.network_cleaner_tool.unloadGUI()

    def run(self):
        """Run method that performs all the real work"""
        self.network_cleaner_tool.loadGUI()
